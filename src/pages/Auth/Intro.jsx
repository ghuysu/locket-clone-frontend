...
export default function Intro({ handleSignUpClick, handleSignInClick }) {
  ...
  useEffect(() => {
    ...
    return () => {
      signInDiv.removeEventListener("mouseenter", () =>
        handleMouseEnter(signInDiv)
      );
      signInDiv.removeEventListener("mouseleave", () =>
        handleMouseLeave(signInDiv)
      );
    };
  }, []);
  ...
  return (
    <div className="bg-black flex flex-col w-full pt-10 border-t-4 border-yellow-500 rounded-lg">
      ...
      <div
        ref={contentRef}
        className="flex space-x-40 justify-center items-top pt-40"
      >
        <img
        ...
        <div className="flex flex-col">
          ...
          <div
            ...
            className="mt-4 bold text-gray p-2 cursor-pointer"
          >
            Sign in
          </div>
        </div>
