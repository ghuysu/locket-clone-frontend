...
function Email({setCode, handleBackClick, setEmail, email}) {
    ...
    const handleClick = async () => {
        ...
        setError('');
        try {
            const response = await fetch('https://skn7vgp9-9876.asse.devtunnels.ms/access/check-email', {
                method: 'POST',
                headers: {
                    'api-key': 'ABC-XYZ-WWW',
...
export default function CheckEmail({handleBackClick, setAuth, setVerifiedEmail}) {
